export default [
	{
		...
		thumbnail: {
			src: {
				small: "/assets/2d/episodes/ep1-small.jpg",
				medium: "/assets/2d/episodes/ep1-medium.jpg",
				large: "/assets/2d/episodes/ep1-large.jpg"
			},
		...
		thumbnail: {
			src: {
				small: "/assets/2d/episodes/ep2-small.jpg",
				medium: "/assets/2d/episodes/ep2-medium.jpg",
				large: "/assets/2d/episodes/ep2-large.jpg"
			},
		...
		thumbnail: {
			src: {
				small: "/assets/2d/episodes/ep3-small.jpg",
				medium: "/assets/2d/episodes/ep3-medium.jpg",
				large: "/assets/2d/episodes/ep3-large.jpg"
			},
	...
	, {
		...
		thumbnail: {
			src: {
				small: "/assets/2d/episodes/ep4-small.jpg",
				medium: "/assets/2d/episodes/ep4-medium.jpg",
				large: "/assets/2d/episodes/ep4-large.jpg"
			},
		...
		poster: {
			src: "/assets/2d/episodes/ep4-large.jpg",
		},
		title: "The Plan",
		synopsis: "Guided by Bishop Heahmund's visions, the Saxons devise a battle plan. Ivar the Boneless strategizes on his own as the Vikings undergo increasing pressure. Bjorn Ironside finds himself in a new territory and must convince the local commander he is a trader and not a raider."
	}
	, {
		...
		thumbnail: {
			src: {
				small: "/assets/2d/episodes/ep5-small.jpg",
				medium: "/assets/2d/episodes/ep5-medium.jpg",
				large: "/assets/2d/episodes/ep5-large.jpg"
			},
		...
		poster: {
			src: "/assets/2d/episodes/ep5-large.jpg",
		},
		title: "The Prisoner",
		...
		thumbnail: {
			src: {
				small: "/assets/2d/episodes/ep6-small.jpg",
				medium: "/assets/2d/episodes/ep6-medium.jpg",
				large: "/assets/2d/episodes/ep6-large.jpg"
			},
		...
		poster: {
			src: "/assets/2d/episodes/ep6-large.jpg",
		},
		title: "The Message",
